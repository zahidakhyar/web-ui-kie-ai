...
--> statement-breakpoint
INSERT INTO `__new_video_renders`("id", "render_id", "mix_id", "image_url", "clip_ids", "status", "r2_url", "duration_seconds", "stage", "created_at", "completed_at", "error_msg") SELECT "id", "render_id", "mix_id", "image_url", NULL, "status", "r2_url", "duration_seconds", "stage", "created_at", "completed_at", "error_msg" FROM `video_renders`;--> statement-breakpoint
