...
export const MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    description:
      "Flexible image-to-image transformation model from Flux 2. Supports multiple reference images, variable aspect ratios and resolutions, and gallery mode for sequential outputs.",
    provider: "KIE.ai",
    tags: ["image-to-image", "flux-2", "flex"],
    parameters: [
      {
        key: "image_input",
        label: "Reference Images",
        ...
        required: true,
        description:
          "Upload reference images to transform. Supported formats: JPEG, PNG, WebP (max 30MB per file). You can upload up to 8 images.",
        maxFiles: 8,
      },
      {
        key: "prompt",
        ...
        required: false,
        description:
          "Describe the transformation or edits you want to apply (optional, max 10000 chars).",
        default: "",
      },
      {
        key: "aspect_ratio",
        ...
        type: "aspect-ratio",
        required: false,
        description: "Choose the aspect ratio of the output image.",
        options: [
          { label: "1:1 (Square)", value: "1:1" },
          { label: "4:3 (Landscape)", value: "4:3" },
          { label: "3:4 (Portrait)", value: "3:4" },
      ...
      },
      {
        ...
        type: "select",
        required: false,
        description: "Output resolution (higher = slower).",
        options: [
          { label: "1K", value: "1K" },
          { label: "2K", value: "2K" },
          { label: "4K", value: "4K" },
  ...
  },
  {
    ...
    description:
      "Professional-grade image-to-image model from Flux 2. Prioritizes fidelity and fine-grained control for high-resolution outputs.",
    provider: "KIE.ai",
    tags: ["image-to-image", "flux-2", "pro", "high-quality"],
    parameters: [
      {
        key: "image_input",
        label: "Reference Images",
        ...
        required: true,
        description:
          "Upload reference images to transform. Supported formats: JPEG, PNG, WebP (max 50MB per file). You can upload up to 12 images.",
        maxFiles: 12,
      },
      {
        key: "prompt",
        ...
        required: true,
        description:
          "Describe the transformation or edits you want to apply (max 20000 chars).",
        default: "",
      },
      {
        key: "aspect_ratio",
      ...
      },
      {
        ...
        type: "select",
        required: false,
        description: "Quality profile (latency vs fidelity).",
        options: [
      ...
      },
      {
        ...
        required: false,
        description:
          "How strongly the model follows the prompt (higher = more adherence).",
        min: 1,
        max: 20,
        step: 0.1,
        default: 7.5,
